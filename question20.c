/*20. Write a C program to read the Roll No, Name, Address, and Age marks
of 12 students in the BCT class and display the details from the function.*/
...
int main() {struct student bctClass[12];
